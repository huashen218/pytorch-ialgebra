...
def main(args):
    ...
    model = load_model(args.model_name, layer=args.layer) 
    ...
    if args.resume:
        ...
        print('==> Resuming from checkpoint: {}'.format(model_save_dir))
        print("pre_train model accuracy: ", best_acc)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--layer', dest='layer', default=None, type=str)
